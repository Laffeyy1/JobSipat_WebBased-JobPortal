...
path("employer/post/delete/<int:job_post_id>/", views.employerPostDelete, name="employerPostDelete"),
...
path("adminPostEdit/<int:job_post_id>/", views.PostEdit, name="PostEdit"), 
path("adminPostDelete/<int:job_post_id>/", views.PostDelete, name="PostDelete"), 
